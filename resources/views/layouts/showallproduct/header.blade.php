              ...
              <div class="col-sm-6">
                  <div class="contactinfo">
                      <ul class="nav nav-pills">
                          <li><a href="#"><i class="fa fa-phone"></i> +91 9374631510</a></li>
                          <li><a href="#"><i class="fa fa-envelope"></i> teeshalace17@gmail.com</a></li>
                      </ul>
                  </div>
              </div>
              <div class="col-sm-6">
...
<section class="jumbotron text-center">
    <div class="container">
      <h1 class="jumbotron-heading">Teesha Lace Collection</h1>

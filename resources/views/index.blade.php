                ...
                <div class="col-sm-3">
                    <div class="left-sidebar">
                        ...
                        <div class="panel-group category-products" id="accordian">
                            <!--category-productsr-->
                            {{-- for the basic need categories and sub categories --}}
                            {{-- <div class="panel panel-default">
                                also add here ? php echo $categories_menu;  ? 
                            </div> --}}
                            <div class="panel panel-default">
                                ...
                                <div class="product-image-wrapper">
                                    <div class="single-products">
                                            <div class="productinfo text-center">
                                                ...
                                                <a href="{{ url('/product/'.$product->id)}}" class="btn btn-default add-to-cart">Get Full Details</a>
